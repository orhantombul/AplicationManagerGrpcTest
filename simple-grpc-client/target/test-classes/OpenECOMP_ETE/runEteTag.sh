...
VARIABLEFILES="-V /opt/eteshare/config/vm_properties.py -V /opt/eteshare/config/integration_robot_properties.py -V /opt/eteshare/config/integration_preload_parameters.py"
