...
public final class SentServiceStatusGrpc {
  ...
  public static final String SERVICE_NAME = "testpythonwithjava.SentServiceStatus";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<testpythonwithjava.ContainerList,
      testpythonwithjava.Response> getContlistMethod;

  public static io.grpc.MethodDescriptor<testpythonwithjava.ContainerList,
      testpythonwithjava.Response> getContlistMethod() {
    io.grpc.MethodDescriptor<testpythonwithjava.ContainerList, testpythonwithjava.Response> getContlistMethod;
      ...
      synchronized (SentServiceStatusGrpc.class) {
        if ((getContlistMethod = SentServiceStatusGrpc.getContlistMethod) == null) {
          SentServiceStatusGrpc.getContlistMethod = getContlistMethod = 
              io.grpc.MethodDescriptor.<testpythonwithjava.ContainerList, testpythonwithjava.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "testpythonwithjava.SentServiceStatus", "contlist"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  testpythonwithjava.ContainerList.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  testpythonwithjava.Response.getDefaultInstance()))
  ...
  public static abstract class SentServiceStatusImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void contlist(testpythonwithjava.ContainerList request,
        io.grpc.stub.StreamObserver<testpythonwithjava.Response> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                testpythonwithjava.ContainerList,
                testpythonwithjava.Response>(
  ...
  public static final class SentServiceStatusBlockingStub extends io.grpc.stub.AbstractStub<SentServiceStatusBlockingStub> {
    ...
    /**
     */
    public testpythonwithjava.Response contlist(testpythonwithjava.ContainerList request) {
  ...
  public static final class SentServiceStatusFutureStub extends io.grpc.stub.AbstractStub<SentServiceStatusFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<testpythonwithjava.Response> contlist(
        testpythonwithjava.ContainerList request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONTLIST:
          serviceImpl.contlist((testpythonwithjava.ContainerList) request,
              (io.grpc.stub.StreamObserver<testpythonwithjava.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class SentServiceStatusBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return testpythonwithjava.ContainerServer.getDescriptor();
    }
